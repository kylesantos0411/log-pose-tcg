      ...
      >
        ...
        <div className="px-6 py-3.5 border-t border-[#34384c] bg-[#1e212c] flex items-center justify-between">
          <Link
            href="/settings"
            onClick={closeSettings}
            className="text-xs font-semibold text-gray-400 hover:text-[#3b82f6] flex items-center gap-1 transition"
          >
            <span>Advanced Settings Page</span>
          ...
          <button
            type="button"
            onClick={closeSettings}
            className="px-5 py-1.5 rounded-xl bg-[#e76d78] hover:bg-[#d45c67] text-white font-bold text-xs transition cursor-pointer shadow-md"
          >
            Done
          </button>
        </div>
