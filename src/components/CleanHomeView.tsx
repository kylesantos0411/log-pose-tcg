...
export function CleanHomeView({ 
  ...
  return (
    <div className="w-full max-w-md sm:max-w-lg mx-auto py-2 sm:py-6 space-y-4 select-none font-sans">
      ...
      {/* =========================================================================
          3. HERO SHOWCASE CARD: Browse All Cards
         ========================================================================= */}
      <Link
        href="/cards"
      ...
      {/* =========================================================================
          4. 2-COLUMN BENTO GRID: Collection (Left) + Sets & Decks (Right Stacked)
         ========================================================================= */}
      <div className="grid grid-cols-2 gap-3 sm:gap-3.5 items-stretch">
        {/* Left Column: TALL HERO CARD -> Collection Binder */}
        <Link
          href="/collection"
        ...
        {/* Right Column: 2 Stacked Tiles (Sets & Decks) */}
      ...
      {/* =========================================================================
          6. SUPPORT SERVER & MAINTENANCE BANNER
         ========================================================================= */}
